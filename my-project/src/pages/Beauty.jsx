...
// Reusing the same component structures but with beauty content
const CategoryCard = ({ category }) => {
  ...
  return (
    <div 
      ...
      onClick={() => navigate(`/BeautyStore/${category.name.toLowerCase().replace(/\s+/g, '-')}`)}
      role="button"
      tabIndex={0}
      onKeyDown={(e) => {
        if (e.key === 'Enter' || e.key === ' ') {
          navigate(`/BeautyStore/${category.name.toLowerCase().replace(/\s+/g, '-')}`);
        }
      }}
    >
  ...
  const [featuredProducts] = useState([
    {
      ...
      price: "899.00",
      image: "/path/to/beauty-product1.webp",
      code: "BC01"
    },
    {
      id: 2,
      ...
      price: "299.00",
      image: "/path/to/beauty-product2.webp",
      code: "BC02"
    },
    {
      id: 3,
      ...
      price: "1499.00",
      image: "/path/to/beauty-product3.webp",
      code: "BC03"
    },
    {
      id: 4,
      name: "Clay Face Mask",
      price: "599.00",
      image: "/path/to/beauty-product4.webp",
      code: "BC04"
    }
  ]);

  const categories = [
    { name: "Skincare", image: "/path/to/skincare.jpg" },
    { name: "Haircare", image: "/path/to/haircare.jpg" },
    { name: "Makeup", image: "/path/to/makeup.jpg" },
    { name: "Body Care", image: "/path/to/bodycare.jpg" },
    { name: "Fragrances", image: "/path/to/fragrances.jpg" },
    { name: "Natural", image: "/path/to/natural.jpg" },
  ];
    ...
    <main className="min-h-screen bg-white">
      ...
      >
        ...
        <div 
          ...
          style={{ 
            backgroundImage: 'url("src/assets/beauty-banner1-mobile.jpg")',
        ...
        <div 
          ...
          style={{ 
            backgroundImage: 'url("src/assets/beauty-banner1.jpg")',
            backgroundSize: 'cover',
            backgroundPosition: 'center',
          }}
        />
      ...
      <section className="max-w-7xl mx-auto py-24 px-4" aria-labelledby="categories-heading">
        ...
        <p className="text-gray-600 text-center mb-16 max-w-2xl mx-auto">
          Discover our curated collection of premium beauty products for your daily routine
        </p>
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-24" aria-labelledby="products-heading">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-gray-600 text-center mb-16 max-w-2xl mx-auto">
            Discover our bestselling beauty products, crafted for your skincare routine
          </p>
      ...
      <section 
        ...
        style={{ backgroundImage: 'url("/path/to/beauty-collection-banner.jpg")' }}
      >
          ...
          <div className="max-w-7xl mx-auto px-4 h-full flex items-center">
            <div className="text-white max-w-xl">
              ...
              <p className="text-lg mt-6 mb-8 text-pink-100">
                Experience our latest collection of natural skincare products.
                Formulated for radiant, healthy skin.
              </p>
