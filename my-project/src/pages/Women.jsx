...
// Reusing the same component structures but with women's content
...
const Women = () => {
  const [featuredProducts] = useState([
    {
      id: 1,
      name: "Cotton Comfort Sports Bra",
      price: "699.00",
      image: "/path/to/women-product1.webp",
      code: "WC28"
    },
    {
      id: 2,
      name: "Premium Cotton V-Neck T-Shirt",
      price: "799.00",
      image: "/path/to/women-product2.webp",
      code: "WC29"
    },
    {
      id: 3,
      ...
      price: "1299.00",
      image: "/path/to/women-product3.webp",
      code: "WC30"
    },
    {
      id: 4,
      ...
      price: "899.00",
      image: "/path/to/women-product4.webp",
      code: "WC31"
    }
  ]);

  const categories = [
    { name: "Sports Bras", image: "/path/to/sports-bras.jpg" },
    { name: "Leggings", image: "/path/to/leggings.jpg" },
    { name: "Tank Tops", image: "/path/to/women-tanks.jpg" },
    { name: "Shorts", image: "/path/to/women-shorts.jpg" },
    { name: "Yoga Wear", image: "/path/to/yoga-wear.jpg" },
    { name: "Loungewear", image: "/path/to/loungewear.jpg" },
  ];
    ...
    <main className="min-h-screen bg-white">
      ...
      >
        ...
        <div 
          ...
          style={{ 
            backgroundImage: 'url("src/assets/women-banner1-mobile.jpg")',
        ...
        <div 
          ...
          style={{ 
            backgroundImage: 'url("src/assets/women-banner1.jpg")',
            backgroundSize: 'cover',
            backgroundPosition: 'center',
          }}
        />
      ...
      <section className="max-w-7xl mx-auto py-24 px-4" aria-labelledby="categories-heading">
        ...
        <p className="text-gray-600 text-center mb-16 max-w-2xl mx-auto">
          Premium activewear and essentials for every moment of your day
        </p>
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-24" aria-labelledby="products-heading">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-gray-600 text-center mb-16 max-w-2xl mx-auto">
            Discover our most-loved pieces, designed for your active lifestyle
          </p>
      ...
      <section 
        ...
        style={{ backgroundImage: 'url("/path/to/women-collection-banner.jpg")' }}
      >
          ...
          <div className="max-w-7xl mx-auto px-4 h-full flex items-center">
            <div className="text-white max-w-xl">
              ...
              <p className="text-lg mt-6 mb-8 text-pink-100">
                Discover our latest collection of premium activewear.
                Designed for movement, styled for life.
              </p>
